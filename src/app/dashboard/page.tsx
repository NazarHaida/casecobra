                ...
                <div className="flex flex-col gap-16">
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        <Card>
                            ...
                            <CardFooter>
                                <Progress value={(lastMonthSum._sum.amount ?? 0) / MONTLY_GOAL * 100}/>
                            </CardFooter>
                        </Card>
                    </div>
                        ...
                        <TableBody>
                            {orders.map((order) => (
                                <TableRow key={order.id} className="bg-accent">
                                    ...
                                    <TableCell
                                        className="hidden md:table-cell">{order.createdAt.toLocaleDateString()}</TableCell>
